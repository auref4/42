...
void	one_cmd(t_lst_cmd *argv, t_cmd *cmd, t_struct_env *s)
{
...
void	exec_one_cmd(t_lst_cmd *argv, t_cmd *cmd, t_struct_env *s)
{
...
void	new_exec_cmds(t_lst_cmd *argv, t_cmd *cmd, t_struct_env *s)
{
	set_fd(cmd);
	set_files(argv, cmd);
...
void	pipex(t_lst_cmd *argv, t_cmd *cmd, t_struct_env *s)
{
	if (cmd->index_pid == cmd->nbr - 1)
		exec_one_cmd(argv, cmd, s);
	else
	{
